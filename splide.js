...
n = this,
    t = function () {
            ...
            function t(n, t, r) {
                e(n, t, function (t, i) {
                    o = o.filter(function (n) {
                        return !!(n[0] !== t || n[1] !== i || r && n[2] !== r) || (t.removeEventListener(i, n[2], n[3]),
                            !1)
                    })
                })
            }
        ...
        var $n = "role"
            ...
            , ft = "fade";
        function at(u, i, r, o) {
            var t, n = Pn(u), e = n.on, c = n.emit, f = n.bind, a = n.destroy, s = u.Components, l = u.root, d = u.options, v = d.isNavigation, h = d.updateOnMove, p = s.Direction.resolve, g = X(o, "style"), m = -1 < r, y = P(o, "." + Wn), w = d.focusableNodes && J(o, d.focusableNodes);
            function _() {
                var n = m ? r : i
        ...
        var _t = Object.freeze({
            ...
            Options: function (t, n, r) {
                ...
                function f() {
                    ...
                    n[0] !== i && function (n) {
                        n = r.breakpoints[n] || u;
                        n.destroy ? (t.options = u,
                            t.destroy("completely" === n.destroy)) : (t.state.is(5) && (c(!0),
                                t.mount()),
                                t.options = n)
                    }(i = n[0])
                }
                return {
                    setup: function () {
                        ...
                        n && (i = "min" === r.mediaQuery,
                            o = Object.keys(n).sort(function (n, t) {
                                return i ? +t - +n : +n - +t
                            }).map(function (n) {
            ...
            Slides: function (r, u, o) {
                ...
                return {
                    ...
                    add: function (n, u) {
                        b(n, function (n) {
                            var t, i, r;
                            y(n = D(n) ? Y(n) : n) && ((t = f[u]) ? S(n, t) : L(a, n),
                                A(n, o.classes.slide),
                                n = n,
                                i = e.bind(null, kn),
                                n = J(n, "img"),
                                (r = n.length) ? n.forEach(function (n) {
            ...
            Layout: function (n, t, i) {
                var r, u, o = Pn(n), e = o.on, c = o.bind, f = o.emit, a = t.Slides, s = t.Direction.resolve, l = (t = t.Elements).root, d = t.track, v = t.list, h = a.getAt;
                function p() {
                    u = null,
                        r = "ttb" === i.direction,
                ...
                function g() {
                    ...
                    u && u.width === n.width && u.height === n.height || (C(d, "height", function () {
                        var n = "";
                        r && (Q(n = y(), "height or heightRatio is missing."),
                            n = "calc(" + n + " - " + m(!1) + " - " + m(!0) + ")");
                        return n
                    }()),
            ...
            Clones: function (c, n, f) {
                ...
                function p() {
                    var n, t, i = f.clones;
                    return c.is(ct) ? i || (n = a.list,
                        D(t = f[o("fixedWidth")]) && (t = G(n = F("div", {
                            style: "width: " + t + "; position: absolute;"
                        }, n)).width,
                            H(n)),
                        i = ((t = t) && rn(G(a.track)[o("width")] / t) || f[o("autoWidth")] && c.length || f.perPage) * (f.drag ? (f.flickMaxPages || 1) + 1 : 2)) : i = 0,
                        i
                }
                return {
                    mount: function () {
            ...
            Move: function (e, c, f) {
                var a, n = Pn(e), t = n.on, s = n.emit, r = (n = c.Layout).slideSize, i = n.getPadding, u = n.totalSize, o = n.listSize, l = n.sliderSize, d = (n = c.Direction).resolve, v = n.orient, h = (n = c.Elements).list, p = n.track;
                function g() {
                    k() || (c.Scroll.cancel(),
                        m(e.index),
                        s(Ln))
                ...
                function _(n, t) {
                    var i, i = v(u(n - 1) - (i = n,
                        "center" === (n = f.focus) ? (o() - r(i, !0)) / 2 : +n * r(i) || 0));
                    return t ? function (n) {
                    ...
                    move: function (n, t, i, r) {
                        ...
                        k() || (u = e.state.set,
                            ...
                            a.start(t, function () {
                                u(3),
                                    s(vn, t, i, n),
                                    "move" === f.trimSpace && n !== i && o === b() ? c.Controller.go(i < n ? ">" : "<", !1, r) : r && r()
                            }))
                    },
                    jump: m,
                    translate: y,
            ...
            Controller: function (n, e, u) {
                var o, c, f, t = Pn(n).on, a = e.Move, s = a.getPosition, l = a.getLimit, i = e.Slides, d = i.isEnough, r = i.getLength, v = n.is(ct), h = n.is(et), p = u.start || 0, g = p;
                function m() {
                    o = r(!0),
                        c = u.perMove,
                        f = u.perPage,
                ...
                function b(n, t) {
                    var i, r, u = c || (P() ? 1 : f), o = x(p + u * (n ? -1 : 1), p);
                    return -1 !== o || !h || (i = s(),
                        r = l(!n),
                        u = 1,
                        un(i - r) < u) ? t ? o : A(o) : n ? 0 : k()
                }
                function x(n, t, i) {
                    var r;
                    return d() ? (r = k(),
                        n < 0 || r < n ? n = on(0, n, t, !0) || on(r, t, n, !0) ? L(E(n)) : v ? c || P() ? n : n < 0 ? -(o % f || f) : o : u.rewind ? n < 0 ? r : 0 : -1 : i || n === t || (n = c ? n : L(E(t) + (n < t ? -1 : 1)))) : n = -1,
                        n
                }
                function k() {
                    var n = o - f;
                        ...
                        var r = function (n) {
                            var t = p;
                            {
                                ...
                                D(n) ? (r = n.match(/([+\-<>])(\d+)?/) || [],
                                    i = r[1],
                                    r = r[2],
                                    "+" === i || "-" === i ? t = x(p + +("" + i + (+r || 1)), p, !0) : ">" === i ? t = r ? L(+r) : w(!0) : "<" === i && (t = _(!0))) : t = v ? n : en(n, 0, k())
                            }
                            return t
                        }(n);
                        u.useScroll ? y(r, !0, !0, u.speed, i) : -1 < (n = A(r)) && !a.isBusy() && (t || n !== p) && (z(n),
                            a.move(r, n, g, i))
                    },
                    scroll: y,
                    getNext: w,
            ...
            Arrows: function (u, n, i) {
                var r, t = Pn(u), o = t.on, e = t.bind, c = t.emit, f = i.classes, a = i.i18n, s = n.Elements, l = n.Controller, d = s.arrows, v = s.prev, h = s.next, p = {};
                function g() {
                    var n, t;
                    i.arrows && (v && h || (d = F("div", f.arrows),
                        v = m(!0),
                        h = m(!1),
                        r = !0,
                        L(d, [v, h]),
                        S(d, P("slider" === i.arrows && s.slider || u.root)))),
                        v && h && (p.prev ? N(d, !1 === i.arrows ? "none" : "") : (n = s.track.id,
                            j(v, nt, n),
                            j(h, nt, n),
                            p.prev = v,
                            p.next = h,
            ...
            Autoplay: function (t, i, r) {
                var u, o, e, n = Pn(t), c = n.on, f = n.bind, a = n.emit, s = Rn(r.interval, t.go.bind(t, ">"), function (n) {
                    var t = d.bar;
                    t && C(t, "width", 100 * n + "%"),
                ...
                function h() {
                    l() && i.Slides.isEnough() && (s.start(!r.resetProgress),
                        o = u = e = !1,
                        a("autoplay:play"))
                }
                function p(n) {
            ...
            Scroll: function (c, n, f) {
                var a, s, t = Pn(c), i = t.on, l = t.emit, d = n.Move, v = d.getPosition, h = d.getLimit, p = d.exceededLimit;
                function g(r, n, t, u) {
                    var i, o = v(), e = 1;
                    n = n || (i = un(r - o),
                        nn(i / 1.5, 800)),
                        ...
                        a = Rn(n, m, function (n) {
                            var t = v()
                                , i = (o + (r - o) * (i = n,
                                    (n = f.easingFunc) ? n(i) : 1 - Math.pow(1 - i, 4)) - v()) * e;
                            d.translate(t + i),
                                c.is(et) && !u && p() && (e *= .6,
                                    un(i) < 10 && (i = p(!1),
                                        g(h(!i), 600, null, !0)))
            ...
            Drag: function (u, o, e) {
                var c, f, a, s, l, d, v, r, h, n = Pn(u), t = n.on, p = n.emit, g = n.bind, m = n.unbind, y = o.Move, w = o.Scroll, _ = o.Controller, b = o.Elements.track, i = (n = o.Direction).resolve, x = n.orient, k = y.getPosition, A = y.exceededLimit, L = !1;
                function E() {
                    var n = e.drag;
                    F(!n),
                        l = "free" === n
                ...
                function S(n) {
                    ...
                    r || (i = e.noDrag,
                        ...
                        i = !i || !W(n.target, i),
                        v = !1,
                        !i || !t && n.button || (y.isBusy() ? U(n, !0) : (h = t ? b : window,
                            s = a = null,
                            g(h, dt, z, lt),
                            g(h, vt, P, lt),
                            y.cancel(),
                ...
                function z(n) {
                    var t, i, r;
                    s || p("drag"),
                        (s = n).cancelable && (t = O(n) - O(f),
                            d ? (y.translate(c + t / (L && u.is(et) ? 5 : 1)),
                                i = 200 < T(n) - T(f),
                                r = L !== (L = A()),
                                (i || r) && R(n),
                                p("dragging"),
                                v = !0,
                                U(n)) : (r = I(r = e.dragMinThreshold) ? r : {
                                    mouse: 0,
                                    touch: +r || 10
                                },
                ...
                function P(n) {
                    ...
                    s ? ((d || n.cancelable && M()) && (t = function (n) {
                        ...
                        U(n)),
                        p("dragged")) : l || k() === y.toPosition(r) || _.go(r, !0),
                        d = !1
                }
                function R(n) {
                    a = f,
            ...
            Keyboard: function (t, n, i) {
                ...
                function l() {
                    var n = i.keyboard;
                    n && ("focused" === n ? j(r = a, ut, 0) : r = window,
                        c(r, pt, p))
                }
                function d() {
                    f(r, pt),
                ...
                function p(n) {
                    u || (n = n.key,
                        (n = x(ht, n) ? "Arrow" + n : n) === s("ArrowLeft") ? t.go("<") : n === s("ArrowRight") && t.go(">"))
                }
                return {
                    mount: function () {
                        l(),
                ...
                function d() {
                    n.Slides.forEach(function (o) {
                        J(o.slide, yt).forEach(function (n) {
                            ...
                            r === n.src && u === n.srcset || (t = e.classes.spinner,
                                j(i = P(i = n.parentElement, "." + t) || F("span", t, i), $n, "presentation"),
                                a.push({
                                    o: n,
                                    e: o,
                                    src: r,
            ...
            Pagination: function (l, n, d) {
                var v, t = Pn(l), i = t.on, r = t.emit, h = t.bind, u = t.unbind, p = n.Slides, g = n.Elements, o = n.Controller, m = o.hasFocus, e = o.getIndex, y = [];
                function c() {
                    f(),
                        d.pagination && p.isEnough() && (function () {
                            var n = l.length
                                , t = d.classes
                                , i = d.i18n
                                , r = d.perPage
            ...
            Wheel: function (i, r, u) {
                ...
                function t(n) {
                    var t;
                    !n.cancelable || (t = n.deltaY) && (i.go((t = t < 0) ? "<" : ">"),
                        t = t,
                        u.releaseWheel && !i.state.is(4) && -1 === r.Controller.getAdjacent(t) || U(n))
                }
                return {
                    mount: function () {
        ...
        function kt(o, n, e) {
            ...
            return {
                ...
                start: function (n, t) {
                    ...
                    1 <= un(i - r) && 1 <= u ? (s("transform " + u + "ms " + e.easing),
                        f.translate(i, !0),
                        c = t) : (f.jump(n),
                            t())
                },
        ...
        i = function () {
            ...
            return r.mount = function (n, t) {
                var i = this
                    , r = this.state
                    , u = this.Components;
                return Q(r.is([1, 5]), "Already mounted!"),
                    r.set(1),
                    this.s = u,
                ...
                r.emit = function (n) {
                    var t;
                    return (t = this.event).emit.apply(t, [n].concat(s(arguments, 1))),
                        this
                }
                ,
                r.add = function (n, t) {
                ...
                (r = [{
                    ...
                    set: function (n) {
                        var t = this.f;
                        l(t, n),
                            this.state.is(1) || this.emit(xn, t)
                    }
                }, {
                    key: "length",
                    get: function () {
